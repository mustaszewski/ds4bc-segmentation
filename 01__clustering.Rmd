...
What we can see here though is that cluster 2, which contains the biggest donors, has view Millennials in it, which was to be expected since younger people have less money to donate.
...
A has the frequent donors in cluster 2, B in 3. 
...
We will try and categorize the clusters in approach A to determine which groups should be focused on in our marketing efforts. Afterwards we will compare the the results of KMeans with those of RFM.
